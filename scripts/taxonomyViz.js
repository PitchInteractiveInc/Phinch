...
(function() {
  ...
  taxonomyViz = (function() {
    ...
    taxonomyViz.prototype.drawBasicDonut = function(donutID, donutName, donutData, donutContainedSamp, posID) {
      ...
      $('#toggle_' + donutID).click((function(_this) {
        return function() {
    ...
    taxonomyViz.prototype.doZip = function(_VizID) {
